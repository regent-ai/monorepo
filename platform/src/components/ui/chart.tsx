          ...
          .map((item, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "flex w-full flex-wrap items-stretch gap-2 leading-none [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-muted-foreground",
