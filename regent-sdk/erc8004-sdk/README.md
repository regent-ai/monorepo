...
Regent is the TypeScript SDK for agentic economies. It enables agents to register, advertise their capabilities and how to communicate with them, and give each other feedback and reputation signals. All this using blockchain infrastructure (ERC-8004) and decentralized storage, enabling permissionless discovery without relying on proprietary catalogues or intermediaries.

## What Does Regent ERC-8004 SDK Do?

Regent ERC-8004 SDK v0.31 enables you to:
...
Regent ERC-8004 SDK v0.31 is in **alpha** with bugs and is not production ready. We're actively testing and improving it.

**Bug reports & feedback:** GitHub: [Report issues](https://github.com/regent-protocol/regent-sdk/issues) | Telegram: [@marcoderossi](https://t.me/marcoderossi) | Email: marco.derossi@consensys.net
...
```bash
npm install @regent/erc8004-sdk
```
...
Full documentation is available at [sdk.ag0.xyz](https://regent.cx/docs), including:

- [Installation Guide](https://regent.cx/docs/2-usage/2-1-install/)
- [Agent Configuration](https://regent.cx/docs/2-usage/2-2-configure-agents/)
- [Registration](https://regent.cx/docs/2-usage/2-3-registration-ipfs/)
- [Search](https://regent.cx/docs/2-usage/2-5-search/)
- [Feedback](https://regent.cx/docs/2-usage/2-6-use-feedback/)
- [Key Concepts](https://regent.cx/docs/1-welcome/1-2-key-concepts/)
- [API Reference](https://regent.cx/docs/5-reference/5-1-sdk/)

## License

Regent ERC-8004 SDK is MIT-licensed public good brought to you by Marco De Rossi in collaboration with Consensys, 🦊 MetaMask and Regent, Inc. We are looking for co-maintainers. Please reach out if you want to help.
