# Release Notes: Regent ERC-8004 SDK v0.2.2
...
```bash
npm install @regent/erc8004-sdk@0.2.2
```

## Full Changelog

- [#4](https://github.com/regent-protocol/regent-sdk/pull/4) - Added filtering by owner and operator addresses
- [#1](https://github.com/regent-protocol/regent-sdk/issues/1) - Fixed npm security vulnerabilities
- [#1](https://github.com/regent-protocol/regent-sdk/issues/1) - Fixed TypeScript build errors for fresh clones
