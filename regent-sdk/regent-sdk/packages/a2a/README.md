...
Complete A2A Protocol implementation for Regent agents. Enables agent-to-agent communication, Agent Card discovery, and task-based operations.
...
import { findSkill } from '@regent/a2a';
...
import { waitForTask } from '@regent/a2a';
...
```typescript
import { fetchAndInvoke, fetchAndSendMessage } from '@regent/a2a';
...
```typescript
import { createA2ARuntime } from '@regent/a2a';
import { createAgentRuntime } from '@regent/core';
...
```typescript
import { fetchAgentCard } from '@regent/a2a';
...
- `@regent/ap2` - AP2 extension for Agent Cards
- `@regent/x402` - Payment utilities for paid agent calls
