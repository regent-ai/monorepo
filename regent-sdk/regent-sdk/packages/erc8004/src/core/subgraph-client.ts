...
// Define subgraph types locally since they may not be available from codegen
// These match the GraphQL schema for the ERC-8004 subgraph
...
export interface SubgraphAgentRegistrationFile {
  ...
  oasfSkills?: string[];
  oasfDomains?: string[];
  trustReputation?: boolean;
  trustCryptoeconomic?: boolean;
  trustTee?: boolean;
  ens?: string | null;
  did?: string | null;
...
export type QueryAgent = SubgraphAgent;
