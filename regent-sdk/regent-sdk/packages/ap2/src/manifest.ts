import type { AgentCardWithEntrypoints, AgentCapabilities } from '@regent/types/a2a';
import type { AP2Config, AP2ExtensionDescriptor, AP2Role } from '@regent/types/ap2';
