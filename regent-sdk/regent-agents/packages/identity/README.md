...
ERC-8004 identity helpers for Regent agents. Register your agent on the ERC-8004 registry and include verifiable on-chain identity in your agent manifest.
...
```typescript
import { generateAgentMetadata } from '@regent/identity';
...
- [Regent docs](https://regent.cx/docs)
