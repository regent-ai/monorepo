...
This is a minimal Bun HTTP agent built with `@regent/core`. It provides a simple starting point with basic entrypoint configuration and optional payment support.
...
- Import types from `@regent/core/types`
...
- [@regent/core documentation](../../../core/README.md)
