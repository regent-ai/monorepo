...
This project was scaffolded with `create-agent-kit` and ships with a ready-to-run agent app built on [`@regent/core`](https://www.npmjs.com/package/@regent/core).
...
- Wire up `@regent/core` configuration and secrets (see `AGENTS.md` in the repo for details).
