...
This is a Bun HTTP agent with ERC-8004 identity registration and trust metadata. It combines `@regent/core` for the agent framework and `@regent/erc8004` for on-chain identity management.
...
- `@regent/erc8004` - ERC-8004 identity helpers
...
- **Generated by:** `generateAgentMetadata()` from `@regent/erc8004`
...
```typescript
import { generateAgentMetadata } from "@regent/erc8004";
...
- [@regent/erc8004 docs](../../../identity/README.md)
