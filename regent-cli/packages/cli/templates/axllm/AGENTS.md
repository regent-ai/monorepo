...
This is a Bun HTTP agent with `@ax-llm/ax` integration for LLM-powered capabilities. It includes payment support via x402 and uses `@regent/core` for agent app creation.
...
**Key Dependencies:**
- `@regent/core` - Agent app framework
...
```typescript
import { createAxLLMClient } from "@regent/core";
...
- [@regent/core docs](../../../core/README.md)
